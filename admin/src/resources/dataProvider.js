/**
 * Custom version of the hydra dataProvider, because they strip out complex
 * objects from the `record` prop, preventing correct prefilling
 * of nested fields.
 *
 * Might not be needed in future.
 *
 * @see https://github.com/api-platform/admin/issues/279
 */
...
import {headersWithToken} from '../App';
